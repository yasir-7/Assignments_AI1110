...
\textbf{12.13.6.18: Question}. If \pr {A \mid B} $>$ \pr{A}, then which of the following is correct :
\begin{align*}
&\textbf{(A)} \pr{(B\mid A)} < \pr{(B)} \\
&\textbf{(B)} \pr{AB} < \pr{A} . \pr{B}  \\
&\textbf{(C)} \pr{B\mid A} > \pr{B} \\ 
&\textbf{(D)} \pr{B\mid A} = \pr{B} 
\end{align*}
\textbf{Answer: (C) $\pr{B\mid A} > \pr{B}$}\\\\
\textbf{Solution}:
Given: $$\pr{A\mid B}>\pr{A}$$ 
$$
\implies  \frac{\pr{AB}}{\pr{B}} > \pr{A}$$
$$
\implies \pr{AB} > \pr{A}.\pr{B}$$
\begin{align}
\implies \frac{\pr{AB}}{\pr{A}} > \pr{B}
\end{align}
We know:
$$ \pr{B\mid A} = \frac{\pr{AB}}{\pr{A}} $$
from(1), 
$$\implies \pr{B\mid A} > \pr{B}       ...............         \textbf{i.e.(C)}$$
